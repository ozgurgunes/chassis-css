...
You can find and customize these variables for key global options in Chassis - CSS’s `scss/_settings.scss` file.

<CxTable class="table table-options">
| Variable                       | Values                             | Description                                                                            |
| ------------------------------ | ---------------------------------- | -------------------------------------------------------------------------------------- |
| `$enable-alternate-forms`      | `true` (default) or `false`        | Enables the [alternate variant]([[docsref:forms/alternate-variant]]) of form components that are controlled via design tokens. |
