...
Responsive variations also exist for each `object-fit` value using the format `.object-fit-{breakpoint}-{value}`, for the following breakpoint abbreviations: `small`, `medium`, `large`, `xlarge`, and `2xlarge`. Classes can be combined for various effects as you need.

<Example class="d-flex overflow-auto" code={`<Placeholder width="140" height="80" class="object-fit-small-contain border rounded" text="Contain on small" markup="img" />
<Placeholder width="140" height="80" class="object-fit-medium-contain border rounded" text="Contain on medium" markup="img" />
<Placeholder width="140" height="80" class="object-fit-large-contain border rounded" text="Contain on large" markup="img" />
<Placeholder width="140" height="80" class="object-fit-xlarge-contain border rounded" text="Contain on xlarge" markup="img" />
<Placeholder width="140" height="80" class="object-fit-2xlarge-contain border rounded" text="Contain on 2xlarge" markup="img" />`} />
...
Object fit utilities are declared in our utilities API in `scss/utilities/_positioning.scss`. [Learn how to use the utilities API.]([[docsref:/utilities/api#using-the-api]])

<ScssDocs name="utils-object-fit" file="scss/utilities/_positioning.scss" />
