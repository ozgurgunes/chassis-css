...
<Example class="cxd-example-zindex-levels fg-main position-relative" code={`<div class="z-3 position-absolute p-xlarge rounded"><span>z-3</span></div>
<div class="z-2 position-absolute p-xlarge rounded"><span>z-2</span></div>
<div class="z-1 position-absolute p-xlarge rounded"><span>z-1</span></div>
<div class="z-0 position-absolute p-xlarge rounded"><span>z-0</span></div>
<div class="z-n1 position-absolute p-xlarge rounded"><span>z-n1</span></div>`} />
...
Learn about our [`z-index` extend]([[docsref:/about/extend#z-index-scales]]).
...
Position utilities are declared in our utilities API in `scss/utilities/_index.scss`. [Learn how to use the utilities API.]([[docsref:/utilities/api#using-the-api]])
