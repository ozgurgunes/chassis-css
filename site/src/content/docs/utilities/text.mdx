...
Change a selection to our monospace font stack with `.font-code` or `.font-monospace`.

<Example code={`<p class="font-code">This is in monospace</p>
<p class="font-monospace">This is also in monospace</p>`} />
