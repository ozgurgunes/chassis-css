...
<Table class="table borderless context alternate" />

### Border Radius

Override the design tokens `border-radius` with css variables.
...
Use css variables to override design tokens.

<Table class="table" style="--cx-td-font-size: 1rem; --cx-cell-padding-y: 1rem" />

Set styles for `<thead>` & `<tbody>` or wrapper with scoping.

<div class="cxd-example">
  <div style="--cx-table-cell-padding-y: 1rem; --cx-table-th-font-size: 1rem;">
    <TableDeep code="false" class="table" headStyle="--cx-cell-padding-y: .25rem" bodyStyle="--cx-td-font-size: 1rem" />
  </div>
</div>
...
<TableDeep class="table" bodyClass="table-divider" />

<TableDeep class="table context primary" bodyClass="table-divider" />
...
<TableDeep class="table" headClass="context default" />
