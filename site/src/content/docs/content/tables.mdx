...
Add `.alternate` to the table element to apply the design tokens based alternate variant to the entire table as in Figma.
...
<Table class="table striped alternate" />
...
<Table class="table striped-columns alternate" />
...
<Table class="table hoverable striped alternate" />
...
<TableDeep class="table hoverable striped alternate" active />
...
<Table class="table bordered alternate" />
...
<Table class="table borderless alternate" />
...
<Callout type="info">
  Both alternate variant and dark mode can be used together. In dark mode, the alternate variant maintains its designer-controlled style but adapts to the dark theme color palette, just as it does in light mode.
</Callout>

<Table class="table alternate primary" theme="dark" />
