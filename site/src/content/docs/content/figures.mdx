---
title: Figures
description: Documentation and examples for displaying related images and text with the figure component in Chassis.
toc: true
---
...
Or use `.attribution` class on `<figcaption>` to name a source.

<Example code={`<figure class="figure">
    <Placeholder width="400" height="300" class="figure-image image-fluid rounded" />
    <figcaption class="attribution text-center">A <cite title="Great Work">Great Work</cite> of Famous Painter.</figcaption>
  </figure>`} />
