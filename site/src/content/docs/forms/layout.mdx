...
Be sure to use `.col-form-label-small` or `.col-form-label-large` to your `<label>`s or `<legend>`s to correctly follow the size of `.form-control-large` and `.form-control-small`.
