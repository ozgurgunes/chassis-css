...
Chassis CSS uses a powerful combination of SCSS and CSS variables to create a flexible form system that adapts to themes and design requirements.

<DocsCSS />

### SCSS foundations

The form styling is built on organized SCSS variable categories, which are compiled into the CSS variable system at build time.
...
#### Form assist variables

These variables style the help text and validation messages:

<ScssDocs name="form-assist-variables" file="scss/_variables.scss" />
