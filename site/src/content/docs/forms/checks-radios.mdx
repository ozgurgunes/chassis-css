...
<Example code={`<div>
    <label class="form-check check-label">
      <input class="check-input" type="checkbox">
      Checkbox within label
    </label>
  </div>
  <div>
    <label class="form-check check-label check-inline">
      <input class="check-input" type="radio" name="radioLabel">
      Radio within label
    </label>
    <label class="form-check check-label check-inline">
      <input class="check-input" type="radio" name="radioLabel">
  ...
  <div>
    <label class="form-check form-switch check-label">
