...
<Example code={`<input type="checkbox" class="button-check" id="button-check-outlined" autocomplete="off">
<label class="button primary" for="button-check-outlined">Single toggle</label><br>
