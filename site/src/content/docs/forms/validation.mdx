...
The `.form-assist` component is hidden by default when validation feedback is present. Add the `.always-show` class to keep form assists visible alongside validation feedback.

Always place form assists and validation feedback elements as siblings after the input group.

<Callout type="info" title="Accessibility">
  The example below demonstrates proper ARIA attribute usage with `aria-describedby` referencing both the feedback and assist elements, ensuring screen readers announce both the error state and help text.
</Callout>

<Example code={`<div class="input-group">
    <span class="input-addon">@</span>
    <input type="text" class="form-input" id="username-input"
      aria-describedby="username-feedback username-assist" placeholder="Username" required>
  </div>
  <div class="invalid-feedback" id="username-feedback"></div>
  <div class="form-assist always-show" id="username-assist">Enter your username</div>
  <div class="mt-medium">
...
Chassis CSS provides several ways to customize validation styles:

### CSS Variables

<ScssDocs name="root-form-validation-variables" file="scss/_root.scss" />

These variables support color mode adaptation, automatically adjusting in dark mode for consistent user experience.
...
You can override or extend this map to create custom validation states beyond the standard valid/invalid states. Each entry can customize colors, icons, tooltip appearance, and focus styles.
