...
Enhance chips with icons to provide additional visual meaning or action affordances. Chassis provides dedicated helper classes to ensure proper icon alignment and spacing.

The `.icon-start` and `.icon-end` classes provide proper alignment and spacing for icons, supporting both SVG icons and icon fonts:
...
<Example class="button-examples" code={`<span class="chip default">
    Default
    <button type="button" class="close-button icon-end" data-cx-dismiss="chip" aria-label="Remove"></button>
  </span>
  <span class="chip primary">
    Primary
    <button type="button" class="close-button icon-end" data-cx-dismiss="chip" aria-label="Remove"></button>
