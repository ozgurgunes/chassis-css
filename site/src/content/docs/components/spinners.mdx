...
<Example code={`<span class="spinner-grow" style="--cx-spinner-size: 3rem;"></span>
...
<span class="spinner" style="--cx-spinner-opacity: .6;"></span>

<span class="vr mx-medium"></span>
`].concat(getData('basic-opacities').map((opacity) => `<div class="spinner spinner-opacity-${opacity.name}" role="status">
    <span class="visually-hidden">Loading...</span>
  </div>`))} />
...
<span class="spinner-border spinner-opacity-subtle"></span>
<span class="spinner-border spinner-opacity-slight"></span>

<span class="vr mx-medium"></span>

<span class="spinner-grow"></span>
<span class="spinner-grow spinner-opacity-subtle"></span>
<span class="spinner-grow spinner-opacity-slight"></span>`} />
