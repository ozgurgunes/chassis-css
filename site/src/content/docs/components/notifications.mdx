...
<Example code={`<div class="notification success d-flex align-items-center" role="alert">
    <svg class="icon notification-icon" area-hidden="true"><use xlink:href="#info-circle-solid"/></svg>
  ...
  <div class="notification success d-flex align-items-center" role="alert">
    <svg class="icon" area-hidden="true"><use xlink:href="#info-circle-solid"/></svg>
...
<Example code={`<div class="notification success d-flex fade show" role="alert">
    ...
    <svg class="icon notification-icon" area-hidden="true"><use xlink:href="#check-solid"/></svg>
    <div>
