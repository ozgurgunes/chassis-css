...
<Example code={`<ul class="nav nav-vertical">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-vertical">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
Collapse vertical navs with the [collapse JavaScript plugin]([[docsref:/components/collapse#usage]]).

<Example code={`<ul class="nav nav-vertical">
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse collapsed" href="#navCollapse1" data-cx-toggle="collapse" aria-expanded="false" aria-controls="navCollapse1">Collapsed Item</a>
      <div class="collapse" id="navCollapse1">
        <nav class="nav nav-vertical ps-medium">
    ...
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse" href="#navCollapse2" data-cx-toggle="collapse" aria-expanded="true" aria-controls="navCollapse2">Collapsable Item</a>
...
Accordions can also be used to create collapsable vertical navs, as shown in the example below.

<Example code={`<ul class="nav nav-vertical" id="navAccordion">
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse" href="#navCollapse3" data-cx-toggle="collapse" aria-expanded="true" aria-controls="navCollapse3">Collapsable Item</a>
    ...
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse collapsed" href="#navCollapse4" data-cx-toggle="collapse" aria-expanded="false" aria-controls="navCollapse4">Collapsable Item</a>
    ...
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse collapsed" href="#navCollapse5" data-cx-toggle="collapse" aria-expanded="false" aria-controls="navCollapse5">Collapsable Item</a>
...
```js
const cxTab = new chassis.Tab('#myTab')
```
