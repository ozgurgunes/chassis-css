...
Implement expandable navigation sections using the collapse plugin.
...
<Example code={`<ul class="nav flex-column">
    ...
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse" href="#navCollapse2" data-cx-toggle="collapse" aria-expanded="true" aria-controls="navCollapse2">Collapsible Item</a>
...
Accordions can also be used to create collapsible vertical navs, as shown in the example below.

<Example code={`<ul class="nav flex-column" id="navAccordion">
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse" href="#navCollapse3" data-cx-toggle="collapse" aria-expanded="true" aria-controls="navCollapse3">Collapsible Item</a>
    ...
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse collapsed" href="#navCollapse4" data-cx-toggle="collapse" aria-expanded="false" aria-controls="navCollapse4">Collapsible Item</a>
    ...
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse collapsed" href="#navCollapse5" data-cx-toggle="collapse" aria-expanded="false" aria-controls="navCollapse5">Collapsible Item</a>
...
<Example code={`<ul class="nav flex-column">
    <li class="nav-item border-bottom">
      <a class="nav-link nav-collapse collapsed" href="#navCollapse1" data-cx-toggle="collapse" aria-expanded="false" aria-controls="navCollapse1">Collapsed Item
...
Variables for `.nav-link` class.

<ScssDocs name="nav-link-css-vars" file="scss/_nav.scss" />
...
Variables for `.nav-collapse` class.

<ScssDocs name="nav-collapse-css-vars" file="scss/_nav.scss" />
