...
Add `.carousel-fade` to your carousel to animate slides with a fade transition instead of a slide. Depending on your carousel content (e.g., text only slides), you may want to add `.bg-main` or some custom CSS to the `.carousel-item`s for proper crossfading.
