...
<Example showMarkup={false} code={`<nav id="navbar-example2" class="navbar bg-evident px-medium mb-medium rounded-2">
  ...
  <div class="scrollspy-example bg-evident p-medium rounded-2" data-cx-spy="scroll" data-cx-target="#navbar-example2" data-cx-root-margin="0px 0px -40%" data-cx-smallooth-scroll="true" tabindex="0">
...
<div data-cx-spy="scroll" data-cx-target="#navbar-example2" data-cx-root-margin="0px 0px -40%" data-cx-smallooth-scroll="true" class="scrollspy-example bg-evident p-medium rounded-2" tabindex="0">
  <h4 id="scrollspyHeading1">First heading</h4>
  <p>...</p>
  <h4 id="scrollspyHeading2">Second heading</h4>
  <p>...</p>
...
<div class="cxd-example">
  <div class="row">
    ...
    <div class="col-8">
      <div data-cx-spy="scroll" data-cx-target="#navbar-example3" data-cx-smallooth-scroll="true" class="scrollspy-example-2" tabindex="0">
        <div id="item-1">
          <h4>Item 1</h4>
          <p>This is some placeholder content for the scrollspy page. Note that as you scroll down the page, the appropriate navigation link is highlighted. It’s repeated throughout the component example. We keep adding some more example copy here to emphasize the scrolling and highlighting.</p>
...
<div class="cxd-example">
  <div class="row">
    ...
    <div class="col-8">
      <div data-cx-spy="scroll" data-cx-target="#list-example" data-cx-smallooth-scroll="true" class="scrollspy-example" tabindex="0">
...
<div class="cxd-example">
  <div class="row">
    ...
    <div class="col-8">
      <div data-cx-spy="scroll" data-cx-target="#simple-list-example" data-cx-offset="0" data-cx-smallooth-scroll="true" class="scrollspy-example" tabindex="0">
