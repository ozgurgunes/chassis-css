  ...
  <div class="row">
    <div class="col-4">
      <div id="list-example" class="list-group">
        <a class="list-item list-action" href="#list-solid-item-1">Item 1</a>
        <a class="list-item list-action" href="#list-solid-item-2">Item 2</a>
        <a class="list-item list-action" href="#list-solid-item-3">Item 3</a>
        <a class="list-item list-action" href="#list-solid-item-4">Item 4</a>
      </div>
    </div>
    <div class="col-8">
      <div data-cx-spy="scroll" data-cx-target="#list-solid-example" data-cx-smooth-scroll="true" class="scrollspy-example" tabindex="0">
