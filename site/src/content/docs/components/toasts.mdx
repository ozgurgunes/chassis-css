...
<Example addStackblitzJs code={`<form>
    <div class="mb-medium">
      ...
      <select class="form-select mt-xsmall" id="selectToastPlacement">
        ...
        <option value="top-xlarge0 start-0 translate-middle-y">Middle left</option>
        <option value="top-xlarge0 start-50 translate-middle">Middle center</option>
        <option value="top-xlarge0 end-0 translate-middle-y">Middle right</option>
