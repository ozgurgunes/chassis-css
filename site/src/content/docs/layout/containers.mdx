...
| --- | --- | --- | --- | --- | --- | --- |
| `.container` | <span class="fg-subtle">100%</span> | 540px | 720px | 960px | 1140px | 1320px |
| `.container-small` | <span class="fg-subtle">100%</span> | 540px | 720px | 960px | 1140px | 1320px |
| `.container-medium` | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | 720px | 960px | 1140px | 1320px |
| `.container-large` | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | 960px | 1140px | 1320px |
| `.container-xlarge` | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | 1140px | 1320px |
| `.container-2xlarge` | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | <span class="fg-subtle">100%</span> | 1320px |
...
Responsive containers allow you to specify a class that is 100% wide until the specified breakpoint is reached, after which we apply `max-width`s for each of the higher breakpoints. For example, `.container-small` is 100% wide to start until the `sm` breakpoint is reached, where it will scale up with `md`, `lg`, `xl`, and `xxl`.
