...
{{< example class="cxd-example-ratios" >}}
...
For example, to create a 2x1 aspect ratio, set `--cx-aspect-ratio: 50%` on the `.ratio`.

{{< example class="cxd-example-ratios" >}}
<div class="ratio" style="--cx-aspect-ratio: 50%;">
  <div>2x1</div>
</div>
{{< /example >}}
...
.ratio-4x3 {
  @include media-breakpoint-up(medium) {
    --cx-aspect-ratio: 50%; // 2x1
  }
}
```

{{< example class="cxd-example-ratios cxd-example-ratios-breakpoint" >}}
<div class="ratio ratio-4x3">
