...
{{< cx-table "table table-utilities" >}}
...
| [`local-vars`](#local-css-vars) | Optional | null | Map of local CSS variables to generate in addition to the CSS rules. |
...
```css
.text-opacity-25 { --cx-text-alpha: .25; }
.text-opacity-50 { --cx-text-alpha: .5; }
.text-opacity-75 { --cx-text-alpha: .75; }
.text-opacity-100 { --cx-text-alpha: 1; }
```
...
.bg-primary {
  --cx-bg-opacity: 1;
  background-color: rgba(var(--cx-primary-rgb), var(--cx-bg-opacity)) !important;
}
```
...
Add the `responsive` boolean to generate responsive utilities (e.g., `.opacity-medium-25`) across [all breakpoints]({{< docsref "/layout/breakpoints" >}}).
...
@media (min-width: 576px) {
  .opacity-small-0 { opacity: 0 !important; }
  .opacity-small-25 { opacity: .25 !important; }
  .opacity-small-50 { opacity: .5 !important; }
  .opacity-small-75 { opacity: .75 !important; }
  .opacity-small-100 { opacity: 1 !important; }
}

@media (min-width: 768px) {
  .opacity-medium-0 { opacity: 0 !important; }
  .opacity-medium-25 { opacity: .25 !important; }
  .opacity-medium-50 { opacity: .5 !important; }
  .opacity-medium-75 { opacity: .75 !important; }
  .opacity-medium-100 { opacity: 1 !important; }
}

@media (min-width: 992px) {
  .opacity-large-0 { opacity: 0 !important; }
  .opacity-large-25 { opacity: .25 !important; }
  .opacity-large-50 { opacity: .5 !important; }
  .opacity-large-75 { opacity: .75 !important; }
  .opacity-large-100 { opacity: 1 !important; }
}

@media (min-width: 1200px) {
  .opacity-xlarge-0 { opacity: 0 !important; }
  .opacity-xlarge-25 { opacity: .25 !important; }
  .opacity-xlarge-50 { opacity: .5 !important; }
  .opacity-xlarge-75 { opacity: .75 !important; }
  .opacity-xlarge-100 { opacity: 1 !important; }
}

@media (min-width: 1400px) {
  .opacity-2xlarge-0 { opacity: 0 !important; }
  .opacity-2xlarge-25 { opacity: .25 !important; }
  .opacity-2xlarge-50 { opacity: .5 !important; }
  .opacity-2xlarge-75 { opacity: .75 !important; }
  .opacity-2xlarge-100 { opacity: 1 !important; }
}
```
