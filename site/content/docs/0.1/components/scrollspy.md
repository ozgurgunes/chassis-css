...
layout: docs
title: Scrollspy
description: Automatically update Chassis - CSS navigation or list group components based on scroll position to indicate which link is currently active in the viewport.
group: components
toc: true
---
...
- On the scrollable container, add `data-cx-spy="scroll"` and `data-cx-target="#navId"` where `navId` is the unique `id` of the associated navigation. If there is no focusable element inside the element, be sure to also include a `tabindex="0"` to ensure keyboard access.
...
<div class="cxd-example">
  <nav id="navbar-example2" class="navbar bg-body-tertiary px-medium mb-medium rounded-2">
  ...
  <div class="scrollspy-example bg-body-tertiary p-medium rounded-2" data-cx-spy="scroll" data-cx-target="#navbar-example2" data-cx-root-margin="0px 0px -40%" data-cx-smooth-scroll="true" tabindex="0">
...
```html
<nav id="navbar-example2" class="navbar bg-body-tertiary px-medium mb-medium">
  <a class="navbar-brand" href="#">Navbar</a>
  <ul class="nav nav-pills">
    <li class="nav-item">
      <a class="nav-link" href="#scrollspyHeading1">First</a>
...
<div data-cx-spy="scroll" data-cx-target="#navbar-example2" data-cx-root-margin="0px 0px -40%" data-cx-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-medium rounded-2" tabindex="0">
  <h4 id="scrollspyHeading1">First heading</h4>
  <p>...</p>
  <h4 id="scrollspyHeading2">Second heading</h4>
  <p>...</p>
    ...
    <div class="col-4">
      <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-large border-end">
        <nav class="nav nav-pills flex-column">
          ...
          <nav class="nav nav-pills flex-column">
            <a class="nav-link ms-medium my-xsmall" href="#item-1-1">Item 1-1</a>
            <a class="nav-link ms-medium my-xsmall" href="#item-1-2">Item 1-2</a>
          </nav>
          <a class="nav-link" href="#item-2">Item 2</a>
          <a class="nav-link" href="#item-3">Item 3</a>
          <nav class="nav nav-pills flex-column">
            <a class="nav-link ms-medium my-xsmall" href="#item-3-1">Item 3-1</a>
            <a class="nav-link ms-medium my-xsmall" href="#item-3-2">Item 3-2</a>
          </nav>
        </nav>
      </nav>
    </div>
...
<div class="cxd-example">
  <div class="row">
    <div class="col-4">
      <div id="simple-list-example" class="d-flex flex-column gap-small simple-list-example-scrollspy text-center">
        <a class="p-xsmall rounded" href="#simple-list-item-1">Item 1</a>
        <a class="p-xsmall rounded" href="#simple-list-item-2">Item 2</a>
        <a class="p-xsmall rounded" href="#simple-list-item-3">Item 3</a>
        <a class="p-xsmall rounded" href="#simple-list-item-4">Item 4</a>
        <a class="p-xsmall rounded" href="#simple-list-item-5">Item 5</a>
      </div>
    </div>
    <div class="col-8">
...
To easily add scrollspy behavior to your topbar navigation, add `data-cx-spy="scroll"` to the element you want to spy on (most typically this would be the `<body>`). Then add the `data-cx-target` attribute with the `id` or class name of the parent element of any Chassis - CSS `.nav` component.
