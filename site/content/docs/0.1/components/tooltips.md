...
layout: docs
title: Tooltips
description: Documentation and examples for adding custom Chassis - CSS tooltips with CSS and JavaScript using CSS3 for animations and data-cx-attributes for local title storage.
group: components
toc: true
---
...
- Tooltips rely on the third party library [Popper](https://popper.js.org/docs/v2/) for positioning. You must include [popper.min.js]({{< param "cdn.popper" >}}) before `chassis.js`, or use one `chassis.bundle.min.js` which contains Popper.
...
As mentioned above, you must initialize tooltips before they can be used. One way to initialize all tooltips on a page would be to select them by their `data-cx-toggle` attribute, like so:
...
{{< callout warning >}}
{{< partial "callouts/warning-data-cx-title-vs-title.md" >}}
{{< /callout >}}
...
You can customize the appearance of tooltips using [CSS variables](#variables). We set a custom class with `data-cx-custom-class="custom-tooltip"` to scope our custom appearance and use it to override a local CSS variable.
...
Hover over the buttons below to see the four tooltips directions: top, right, bottom, and left. Directions are mirrored when using Chassis - CSS in RTL.

<div class="cxd-example tooltip-demo">
  <div class="cxd-example-tooltips">
...
<div class="cxd-example tooltip-demo">
  <a href="#" class="d-inline-block" data-cx-toggle="tooltip" data-cx-title="Default tooltip">
