...
{{< example >}}
<input class="form-control large" type="text" placeholder=".large" aria-label=".large example">
<input class="form-control" type="text" placeholder="Default input" aria-label="default input example">
<input class="form-control small" type="text" placeholder=".small" aria-label=".small example">
{{< /example >}}
...
If you want to have `<input readonly>` elements in your form styled as plain text, add `.plaintext` to remove the default form field styling and preserve the correct `margin` and `padding`.
...
<div class="mb-3">
  ...
  <input class="form-control small" id="formFileSm" type="file">
</div>
<div>
  <label for="formFileLg" class="form-label">Large file input example</label>
  <input class="form-control large" id="formFileLg" type="file">
</div>
{{< /example >}}
...
<input type="color" class="form-control color-control" id="exampleColorInput" value="#563d7c" title="Choose your color">
{{< /example >}}
