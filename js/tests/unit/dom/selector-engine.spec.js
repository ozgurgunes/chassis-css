...
describe('SelectorEngine', () => {
  ...
  describe('getSelectorFromElement', () => {
    it('should get selector from data-cx-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-cx-target=".target"></div>',
    ...
    it('should get selector from href if no data-cx-target set', () => {
      fixtureEl.innerHTML = [
    ...
    it('should get selector from href if data-cx-target equal to #', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-cx-target="#" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return null if a selector from a href is a url without an anchor', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-cx-target="#" href="foo/bar.html"></a>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should return the anchor if a selector from a href is a url', () => {
      fixtureEl.innerHTML = [
        '<a id="test" data-cx-target="#" href="foo/bar.html#target"></a>',
        '<div id="target"></div>'
      ].join('')
  ...
  describe('getElementFromSelector', () => {
    it('should get element from data-cx-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-cx-target=".target"></div>',
        '<div class="target"></div>'
      ].join('')
    ...
    it('should get element from href if no data-cx-target set', () => {
      fixtureEl.innerHTML = [
        '<a id="test" href=".target"></a>',
        '<div class="target"></div>'
      ].join('')
  ...
  describe('getMultipleElementsFromSelector', () => {
    it('should get elements from data-cx-target', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-cx-target=".target"></div>',
        '<div class="target"></div>',
        '<div class="target"></div>'
    ...
    it('should get elements if several ids are given', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-cx-target="#target1,#target2"></div>',
    ...
    it('should get elements if several ids with special chars are given', () => {
      fixtureEl.innerHTML = [
        '<div id="test" data-cx-target="#j_id11:exampleModal,#j_id22:exampleModal"></div>',
    ...
    it('should get elements in array, from href if no data-cx-target set', () => {
      fixtureEl.innerHTML = [
        '<a id="test" href=".target"></a>',
        '<div class="target"></div>',
        '<div class="target"></div>'
