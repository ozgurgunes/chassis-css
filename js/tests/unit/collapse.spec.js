...
describe('Collapse', () => {
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(Collapse.DATA_KEY).toEqual('vl.collapse')
    })
  })
  ...
  describe('constructor', () => {
    ...
    it('should allow jquery object in parent config', () => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <a data-cx-toggle="collapse" href="#">Toggle item</a>',
  ...
  describe('toggle', () => {
    ...
    it('should find collapse children if they have collapse class too not only data-cx-parent', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="my-collapse">',
          '  <div class="item">',
          '    <a data-cx-toggle="collapse" href="#">Toggle item 1</a>',
          '    <div id="collapse1" class="collapse show">Lorem ipsum 1</div>',
          '  </div>',
          '  <div class="item">',
          '    <a id="triggerCollapse2" data-cx-toggle="collapse" href="#">Toggle item 2</a>',
        ...
        collapseEl2.addEventListener('shown.vl.collapse', () => {
  ...
  describe('show', () => {
    ...
    it('should show a collapsed element', () => {
      return new Promise(resolve => {
        ...
        collapseEl.addEventListener('show.vl.collapse', () => {
          expect(collapseEl.style.height).toEqual('0px')
        })
        collapseEl.addEventListener('shown.vl.collapse', () => {
    ...
    it('should collapse only the first collapse', () => {
      return new Promise(resolve => {
        ...
        el1.addEventListener('shown.vl.collapse', () => {
    ...
    it('should be able to handle toggling of other children siblings', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <button data-cx-target="#parentContent" data-cx-toggle="collapse" class="accordion-toggle">Parent</button>',
          '  </div>',
          '  <div id="parentContent" class="accordion-collapse collapse" data-cx-parent="#parentGroup">',
          '    <div class="accordion-body">',
          '      <div id="childGroup" class="accordion">',
          '        <div class="accordion-item">',
          '          <div class="accordion-header">',
          '            <button data-cx-target="#childContent1" data-cx-toggle="collapse" class="accordion-toggle">Child 1</button>',
          '          </div>',
          '          <div id="childContent1" class="accordion-collapse collapse" data-cx-parent="#childGroup">',
          '            <div>content</div>',
          '          </div>',
          '        </div>',
          '        <div class="accordion-item">',
          '          <div class="accordion-header">',
          '            <button data-cx-target="#childContent2" data-cx-toggle="collapse" class="accordion-toggle">Child 2</button>',
          '          </div>',
          '          <div id="childContent2" class="accordion-collapse collapse" data-cx-parent="#childGroup">',
          '            <div>content</div>',
          '          </div>',
          '        </div>',
          '      </div>',
        ...
        const parentBtn = el('[data-cx-target="#parentContent"]')
        const childBtn1 = el('[data-cx-target="#childContent1"]')
        const childBtn2 = el('[data-cx-target="#childContent2"]')

        const parentCollapseEl = el('#parentContent')
        const childCollapseEl1 = el('#childContent1')
        const childCollapseEl2 = el('#childContent2')

        parentCollapseEl.addEventListener('shown.vl.collapse', () => {
          expect(parentCollapseEl).toHaveClass('show')
          childBtn1.click()
        })
        childCollapseEl1.addEventListener('shown.vl.collapse', () => {
          expect(childCollapseEl1).toHaveClass('show')
          childBtn2.click()
        })
        childCollapseEl2.addEventListener('shown.vl.collapse', () => {
    ...
    it('should not change tab tabpanels descendants on accordion', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '      <button class="accordion-button" type="button" data-cx-toggle="collapse" data-cx-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">',
          '        Accordion Item #1',
          '      </button>',
          '    </h2>',
          '    <div id="collapseOne" class="accordion-collapse collapse show" data-cx-parent="#accordionExample">',
          '      <div class="accordion-body">',
          '        <nav>',
        ...
        el.addEventListener('hidden.vl.collapse', () => {
          collapse.show()
        })

        el.addEventListener('shown.vl.collapse', () => {
    ...
    it('should not fire shown when show is prevented', () => {
      return new Promise((resolve, reject) => {
        ...
        collapseEl.addEventListener('show.vl.collapse', event => {
  ...
  describe('hide', () => {
    ...
    it('should hide a collapsed element', () => {
      return new Promise(resolve => {
        ...
        collapseEl.addEventListener('hidden.vl.collapse', () => {
    ...
    it('should not fire hidden when hide is prevented', () => {
      return new Promise((resolve, reject) => {
        ...
        collapseEl.addEventListener('hide.vl.collapse', event => {
          event.preventDefault()
          expectEnd()
        })
  ...
  describe('data-api', () => {
    it('should prevent url change if click on nested elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a role="button" data-cx-toggle="collapse" class="collapsed" href="#collapse">',
          '  <span id="nested"></span>',
          '</a>',
    ...
    it('should show multiple collapsed elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a role="button" data-cx-toggle="collapse" class="collapsed" href=".multi"></a>',
        ...
        collapse2.addEventListener('shown.vl.collapse', () => {
    ...
    it('should hide multiple collapsed elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a role="button" data-cx-toggle="collapse" href=".multi"></a>',
        ...
        collapse2.addEventListener('hidden.vl.collapse', () => {
    ...
    it('should remove "collapsed" class from target when collapse is shown', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a id="link1" role="button" data-cx-toggle="collapse" class="collapsed" href="#" data-cx-target="#test1"></a>',
          '<a id="link2" role="button" data-cx-toggle="collapse" class="collapsed" href="#" data-cx-target="#test1"></a>',
          '<div id="test1"></div>'
        ].join('')
        ...
        collapseTest1.addEventListener('shown.vl.collapse', () => {
    ...
    it('should add "collapsed" class to target when collapse is hidden', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a id="link1" role="button" data-cx-toggle="collapse" href="#" data-cx-target="#test1"></a>',
          '<a id="link2" role="button" data-cx-toggle="collapse" href="#" data-cx-target="#test1"></a>',
        ...
        collapseTest1.addEventListener('hidden.vl.collapse', () => {
    ...
    it('should allow accordion to use children other than card', () => {
      return new Promise(resolve => {
        ...
        collapseOne.addEventListener('shown.vl.collapse', () => {
          expect(collapseOne).toHaveClass('show')
          expect(collapseTwo).not.toHaveClass('show')

          collapseTwo.addEventListener('shown.vl.collapse', () => {
    ...
    it('should not prevent event for input', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<input type="checkbox" data-cx-toggle="collapse" data-cx-target="#collapsediv1">',
    ...
    it('should allow accordion to contain nested elements', () => {
      return new Promise(resolve => {
        ...
        collapseOneEl.addEventListener('shown.vl.collapse', () => {
          ...
          collapseTwoEl.addEventListener('shown.vl.collapse', () => {
    ...
    it('should allow accordion to target multiple elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div id="accordion">',
          '  <a id="linkTriggerOne" data-cx-toggle="collapse" data-cx-target=".collapseOne" href="#" aria-expanded="false" aria-controls="collapseOne"></a>',
          '  <a id="linkTriggerTwo" data-cx-toggle="collapse" data-cx-target=".collapseTwo" href="#" aria-expanded="false" aria-controls="collapseTwo"></a>',
          '  <div id="collapseOneOne" class="collapse collapseOne" role="tabpanel" data-cx-parent="#accordion"></div>',
          '  <div id="collapseOneTwo" class="collapse collapseOne" role="tabpanel" data-cx-parent="#accordion"></div>',
          '  <div id="collapseTwoOne" class="collapse collapseTwo" role="tabpanel" data-cx-parent="#accordion"></div>',
          '  <div id="collapseTwoTwo" class="collapse collapseTwo" role="tabpanel" data-cx-parent="#accordion"></div>',
          '</div>'
        ].join('')
        ...
        collapseOneOne.addEventListener('shown.vl.collapse', () => {
        ...
        collapseOneTwo.addEventListener('shown.vl.collapse', () => {
          if (collapsedElements.one) {
            firstTest()
          } else {
            collapsedElements.one = true
        ...
        collapseTwoOne.addEventListener('shown.vl.collapse', () => {
        ...
        collapseTwoTwo.addEventListener('shown.vl.collapse', () => {
          if (collapsedElements.two) {
            secondTest()
          } else {
            collapsedElements.two = true
    ...
    it('should collapse accordion children but not nested accordion children', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <div class="item">',
          '    <a id="linkTrigger" data-cx-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"></a>',
          '    <div id="collapseOne" data-cx-parent="#accordion" class="collapse" role="tabpanel">',
          '      <div id="nestedAccordion">',
          '        <div class="item">',
          '          <a id="nestedLinkTrigger" data-cx-toggle="collapse" href="#nestedCollapseOne" aria-expanded="false" aria-controls="nestedCollapseOne"></a>',
          '          <div id="nestedCollapseOne" data-cx-parent="#nestedAccordion" class="collapse" role="tabpanel"></div>',
          '        </div>',
          '      </div>',
          '    </div>',
          '  </div>',
          '  <div class="item">',
          '    <a id="linkTriggerTwo" data-cx-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>',
          '    <div id="collapseTwo" data-cx-parent="#accordion" class="collapse show" role="tabpanel"></div>',
          '  </div>',
          '</div>'
        ].join('')
        ...
        function handlerCollapseOne() {
          ...
          nestedCollapseOne.addEventListener('shown.vl.collapse', handlerNestedCollapseOne)
          nestedTrigger.click()
          collapseOne.removeEventListener('shown.vl.collapse', handlerCollapseOne)
        }
        ...
        function handlerNestedCollapseOne() {
          ...
          triggerTwo.click()
          nestedCollapseOne.removeEventListener('shown.vl.collapse', handlerNestedCollapseOne)
        }

        collapseOne.addEventListener('shown.vl.collapse', handlerCollapseOne)
        trigger.click()
      })
    })
    ...
    it('should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a id="trigger1" role="button" data-cx-toggle="collapse" href="#test1"></a>',
          '<a id="trigger2" role="button" data-cx-toggle="collapse" href="#0/my/id"></a>',
          '<a id="trigger3" role="button" data-cx-toggle="collapse" href=".multi"></a>',
        ...
        const target2Shown = () => {
          ...
          target2.addEventListener('hidden.vl.collapse', () => {
            expect(trigger1).not.toHaveClass('collapsed')
            expect(trigger1.getAttribute('aria-expanded')).toEqual('true')
            ...
            target1.addEventListener('hidden.vl.collapse', () => {
        ...
        target2.addEventListener('shown.vl.collapse', target2Shown)
        trigger3.click()
      })
    })
  })
