...
describe('Button', () => {
  ...
  it('should take care of element either passed as a CSS selector or DOM element', () => {
    fixtureEl.innerHTML = '<button data-cx-toggle="button">Placeholder</button>'
    const buttonEl = fixtureEl.querySelector('[data-cx-toggle="button"]')
    const buttonBySelector = new Button('[data-cx-toggle="button"]')
