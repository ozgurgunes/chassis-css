...
describe('Tab', () => {
  ...
  describe('show', () => {
    it('should activate element by tab id (using buttons, the preferred semantic way)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <li><button type="button" id="triggerProfile" data-cx-target="#profile" role="tab">Profile</button></li>',
          '</ul>',
          '<ul>',
    ...
    it('should activate element by tab id in nav list', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<nav class="nav">',
          '  <button type="button" data-cx-target="#home" role="tab">Home</button>',
          '  <button type="button" id="triggerProfile" data-cx-target="#profile" role="tab">Profile</button>',
          '</nav>',
          '<div>',
    ...
    it('should not fire shown when tab is already active', () => {
      return new Promise((resolve, reject) => {
        fixtureEl.innerHTML = [
          ...
          '  <li class="nav-item" role="presentation"><button type="button" data-cx-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" data-cx-target="#profile" class="nav-link" role="tab">Profile</button></li>',
          '</ul>',
    ...
    it('show and shown events should reference correct relatedTarget', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" data-cx-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" id="triggerProfile" data-cx-target="#profile" class="nav-link" role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
          '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
          '  <div class="tab-pane" id="profile" role="tabpanel"></div>',
    ...
    it('should fire hide and hidden events', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><button type="button" data-cx-target="#home" role="tab">Home</button></li>',
          '  <li><button type="button" data-cx-target="#profile" role="tab">Profile</button></li>',
          '</ul>'
        ].join('')
    ...
    it('should not focus on opened tab', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><button type="button" id="home" data-cx-target="#home" role="tab">Home</button></li>',
          '  <li><button type="button" id="triggerProfile" data-cx-target="#profile" role="tab">Profile</button></li>',
          '</ul>',
          '<ul>',
          '  <li id="home" role="tabpanel"></li>',
  ...
  describe('_setInitialAttributes', () => {
    it('should put aria attributes', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav">',
        '  <li class="nav-link" id="foo" data-cx-target="#panel"></li>',
        '  <li class="nav-link" data-cx-target="#panel2"></li>',
        '</ul>',
        '<div id="panel"></div>',
        '<div id="panel2"></div>'
      ].join('')
  ...
  describe('_keydown', () => {
    it('if event is not one of left/right/up/down arrow, ignore it', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav">',
        '  <li class="nav-link" data-cx-toggle="tab"></li>',
        '</ul>'
      ].join('')
    ...
    it('if keydown event is right/down arrow, handle it', () => {
      fixtureEl.innerHTML = [
        '<div class="nav">',
        '  <span id="tab1" class="nav-link" data-cx-toggle="tab"></span>',
        '  <span id="tab2" class="nav-link" data-cx-toggle="tab"></span>',
        '  <span id="tab3" class="nav-link" data-cx-toggle="tab"></span>',
        '</div>'
      ].join('')
    ...
    it('if keydown event is right arrow and next element is disabled', () => {
      fixtureEl.innerHTML = [
        '<div class="nav">',
        '  <span id="tab1" class="nav-link" data-cx-toggle="tab"></span>',
        '  <span id="tab2" class="nav-link" data-cx-toggle="tab" disabled></span>',
        '  <span id="tab3" class="nav-link disabled" data-cx-toggle="tab"></span>',
        '  <span id="tab4" class="nav-link" data-cx-toggle="tab"></span>',
        '</div>'
      ].join('')
    ...
    it('if keydown event is Home and first element is disabled', () => {
      fixtureEl.innerHTML = [
        '<div class="nav">',
        '  <span id="tab1" class="nav-link disabled" data-cx-toggle="tab" disabled></span>',
        '  <span id="tab2" class="nav-link" data-cx-toggle="tab"></span>',
        '  <span id="tab3" class="nav-link" data-cx-toggle="tab"></span>',
        '</div>'
      ].join('')
    ...
    it('if keydown event is End and last element is disabled', () => {
      fixtureEl.innerHTML = [
        ...
        '  <span id="tab1" class="nav-link" data-cx-toggle="tab"></span>',
        '  <span id="tab2" class="nav-link" data-cx-toggle="tab"></span>',
        '  <span id="tab3" class="nav-link" data-cx-toggle="tab" disabled></span>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    it('should create dynamically a tab', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" data-cx-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" id="triggerProfile" data-cx-toggle="tab" data-cx-target="#profile" class="nav-link" role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
          '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
          '  <div class="tab-pane" id="profile" role="tabpanel"></div>',
    ...
    it('should handle nested tabs', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <button type="button" id="tab1" data-cx-target="#x-tab1" class="nav-link" data-cx-toggle="tab" role="tab" aria-controls="x-tab1">Tab 1</button>',
          '  <button type="button" data-cx-target="#x-tab2" class="nav-link active" data-cx-toggle="tab" role="tab" aria-controls="x-tab2" aria-selected="true">Tab 2</button>',
          '  <button type="button" data-cx-target="#x-tab3" class="nav-link" data-cx-toggle="tab" role="tab" aria-controls="x-tab3">Tab 3</button>',
          '</nav>',
          '<div class="tab-content">',
          '  <div class="tab-pane" id="x-tab1" role="tabpanel">',
          '    <nav class="nav nav-tabs" role="tablist">',
          '      <button type="button" data-cx-target="#nested-tab1" class="nav-link active" data-cx-toggle="tab" role="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab 1</button>',
          '      <button type="button" id="tabNested2" data-cx-target="#nested-tab2" class="nav-link" data-cx-toggle="tab" role="tab" aria-controls="x-profile">Nested Tab2</button>',
          '    </nav>',
          '    <div class="tab-content">',
    ...
    it('should not remove fade class if no active pane is present', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" id="tab-home" data-cx-target="#home" class="nav-link" data-cx-toggle="tab" role="tab">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" id="tab-profile" data-cx-target="#profile" class="nav-link" data-cx-toggle="tab" role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
    ...
    it('should add `show` class to tab panes if there is no `.fade` class', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation">',
          '    <button type="button" class="nav-link nav-tab" data-cx-target="#home" role="tab" data-cx-toggle="tab">Home</button>',
          '  </li>',
          '  <li class="nav-item" role="presentation">',
          '    <button type="button" id="secondNav" class="nav-link nav-tab" data-cx-target="#profile" role="tab" data-cx-toggle="tab">Profile</button>',
          '  </li>',
          '</ul>',
          '<div class="tab-content">',
    ...
    it('should prevent default when the trigger is <a> or <area>', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><a type="button" href="#test"  class="active" role="tab" data-cx-toggle="tab">Home</a></li>',
          '  <li><a type="button" href="#test2" role="tab" data-cx-toggle="tab">Home</a></li>',
          '</ul>'
        ].join('')
    ...
    it('should not fire shown when tab has disabled attribute', () => {
      return new Promise((resolve, reject) => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" data-cx-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" data-cx-target="#profile" class="nav-link" disabled role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
          '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
          '  <div class="tab-pane" id="profile" role="tabpanel"></div>',
