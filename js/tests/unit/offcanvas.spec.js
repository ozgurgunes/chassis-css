...
describe('Offcanvas', () => {
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(Offcanvas.DATA_KEY).toEqual('vl.offcanvas')
    })
  })

  describe('constructor', () => {
    it('should call hide when a element with data-cx-dismiss="offcanvas" is clicked', () => {
      fixtureEl.innerHTML = [
        '<div class="offcanvas">',
        '  <a href="#" data-cx-dismiss="offcanvas">Close</a>',
        '</div>'
      ].join('')
    ...
    it('should not hide if esc is pressed but with keyboard = false', () => {
      return new Promise(resolve => {
        ...
        offCanvasEl.addEventListener('hidePrevented.vl.offcanvas', hidePreventedSpy)

        offCanvasEl.addEventListener('shown.vl.offcanvas', () => {
    ...
    it('should call `hide` on resize, if element\'s position is not fixed any more', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<div class="offcanvas-large"></div>'
  ...
  describe('config', () => {
    ...
    it('should read data attributes and override default config', () => {
      fixtureEl.innerHTML = '<div class="offcanvas" data-cx-scroll="true" data-cx-backdrop="false" data-cx-keyboard="false"></div>'
  ...
  describe('options', () => {
    it('if scroll is enabled, should allow body to scroll while offcanvas is open', () => {
      return new Promise(resolve => {
        ...
        offCanvasEl.addEventListener('hidden.vl.offcanvas', () => {
  ...
  describe('show', () => {
    it('should add `showing` class during opening and `show` class on end', () => {
      return new Promise(resolve => {
        ...
        offCanvasEl.addEventListener('show.vl.offcanvas', () => {
    ...
    it('should not fire shown when show is prevented', () => {
      return new Promise((resolve, reject) => {
        ...
        offCanvasEl.addEventListener('show.vl.offcanvas', event => {
  ...
  describe('hide', () => {
    it('should add `hiding` class during closing and remover `show` & `hiding` classes on end', () => {
      return new Promise(resolve => {
        ...
        offCanvasEl.addEventListener('hide.vl.offcanvas', () => {
          expect(offCanvasEl).not.toHaveClass('showing')
          expect(offCanvasEl).toHaveClass('show')
        })
    ...
    it('should not fire hidden when hide is prevented', () => {
      return new Promise((resolve, reject) => {
        ...
        offCanvasEl.addEventListener('hide.vl.offcanvas', event => {
          event.preventDefault()
          expectEnd()
        })
  ...
  describe('data-api', () => {
    it('should not prevent event for input', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<input type="checkbox" data-cx-toggle="offcanvas" data-cx-target="#offcanvasdiv1">',
    ...
    it('should not call toggle on disabled elements', () => {
      fixtureEl.innerHTML = [
        '<a href="#" data-cx-toggle="offcanvas" data-cx-target="#offcanvasdiv1" class="disabled"></a>',
        '<div id="offcanvasdiv1" class="offcanvas"></div>'
      ].join('')
    ...
    it('should call hide first, if another offcanvas is open', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<button id="btn2" data-cx-toggle="offcanvas" data-cx-target="#offcanvas2"></button>',
        ...
        offcanvasEl1.addEventListener('shown.vl.offcanvas', () => {
          trigger2.click()
        })
        offcanvasEl1.addEventListener('hidden.vl.offcanvas', () => {
    ...
    it('should focus on trigger element after closing offcanvas', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<button id="btn" data-cx-toggle="offcanvas" data-cx-target="#offcanvas"></button>',
