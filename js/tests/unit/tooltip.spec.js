...
describe('Tooltip', () => {
  ...
  describe('constructor', () => {
    ...
    it('should not take care of disallowed data attributes', () => {
      fixtureEl.innerHTML = '<a href="#" rel="tooltip" data-cx-sanitize="false" title="Another tooltip"></a>'
    ...
    it('should create offset modifier when offset option is passed in data attribute', () => {
      fixtureEl.innerHTML = '<a href="#" rel="tooltip" data-cx-offset="10,20" title="Another tooltip"></a>'
  ...
  describe('dispose', () => {
    ...
    it('should destroy a tooltip and reset it\'s initial title', () => {
      fixtureEl.innerHTML = [
        ...
        '<span id="tooltipWithoutTitle" rel="tooltip" data-cx-title="tooltipTitle"></span>'
      ].join('')
  ...
  describe('show', () => {
    ...
    it('should not hide tooltip if leave event occurs and enter event occurs within the hide delay', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<a href="#" rel="tooltip" title="Another tooltip" data-cx-delay=\'{"show":0,"hide":150}\'>'
    ...
    it('should show a tooltip with custom class provided in data attributes', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<a href="#" rel="tooltip" title="Another tooltip" data-cx-custom-class="custom-class"></a>'
  ...
  describe('setContent', () => {
    ...
    it('"setContent" should keep the initial template', () => {
      ...
      expect(tip).toHaveClass('cx-tooltip-auto')
