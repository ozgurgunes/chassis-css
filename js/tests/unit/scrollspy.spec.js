...
describe('ScrollSpy', () => {
  ...
  const getDummyFixture = () => {
    return [
      ...
      '  </ul>',
      '</nav>',
      '<div class="content" data-cx-target="#navBar" style="overflow-y: auto">',
  ...
  describe('constructor', () => {
    ...
    it('should respect threshold option markup', () => {
      fixtureEl.innerHTML = [
        ...
        '   <a class="nav-link active" id="one-link" href="#">One</a>' +
        '</ul>',
        '<div id="content" data-cx-threshold="0,0.2,1">',
        '  <div id="one-link">test</div>',
        '</div>'
      ].join('')
  ...
  describe('event handler', () => {
    it('should create scrollspy on window load event', () => {
      fixtureEl.innerHTML = [
        '<div id="nav"></div>' +
        '<div id="wrapper" data-cx-spy="scroll" data-cx-target="#nav" style="overflow-y: auto"></div>'
      ].join('')
