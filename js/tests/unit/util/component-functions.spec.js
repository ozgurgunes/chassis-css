...
describe('Plugin functions', () => {
  ...
  describe('data-cx-dismiss functionality', () => {
    it('should get Plugin and execute the given method, when a click occurred on data-cx-dismiss="PluginName"', () => {
      fixtureEl.innerHTML = [
        '<div id="foo" class="test">',
        '  <button type="button" data-cx-dismiss="test" data-cx-target="#foo"></button>',
        '</div>'
      ].join('')
      ...
      const btnClose = fixtureEl.querySelector('[data-cx-dismiss="test"]')
    ...
    it('if data-cx-dismiss="PluginName" hasn\'t got "data-cx-target", "getOrCreateInstance" has to be initialized by closest "plugin.Name" class', () => {
      fixtureEl.innerHTML = [
        '<div id="foo" class="test">',
        '  <button type="button" data-cx-dismiss="test"></button>',
        '</div>'
      ].join('')
    ...
    it('if data-cx-dismiss="PluginName" is disabled, must not trigger function', () => {
      fixtureEl.innerHTML = [
        '<div id="foo" class="test">',
        '  <button type="button" disabled data-cx-dismiss="test"></button>',
        '</div>'
      ].join('')
    ...
    it('should prevent default when the trigger is <a> or <area>', () => {
      fixtureEl.innerHTML = [
        '<div id="foo" class="test">',
        '  <a type="button" data-cx-dismiss="test"></a>',
        '</div>'
      ].join('')
