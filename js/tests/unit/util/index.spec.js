...
describe('Util', () => {
  ...
  describe('getjQuery', () => {
    ...
    it('should not return jQuery object when present if data-cx-no-jquery', () => {
      document.body.setAttribute('data-cx-no-jquery', '')

      expect(window.jQuery).toEqual(fakejQuery)
      expect(Util.getjQuery()).toBeNull()

      document.body.removeAttribute('data-cx-no-jquery')
    })
