...
describe('Carousel', () => {
  ...
  describe('constructor', () => {
    ...
    it('should start cycling if `ride`===`carousel`', () => {
      fixtureEl.innerHTML = '<div id="myCarousel" class="carousel slide" data-cx-ride="carousel"></div>'
    ...
    it('should not start cycling if `ride`!==`carousel`', () => {
      fixtureEl.innerHTML = '<div id="myCarousel" class="carousel slide" data-cx-ride="true"></div>'
    ...
    it('should ignore keyboard events if data-cx-keyboard=false', () => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide" data-cx-keyboard="false">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active">item 1</div>',
        '    <div id="item2" class="carousel-item">item 2</div>',
        '  </div>',
    ...
    it('should ignore mouse events if data-cx-pause=false', () => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide" data-cx-pause="false">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active">item 1</div>',
        '    <div id="item2" class="carousel-item">item 2</div>',
        '  </div>',
    ...
    it('should call `maybeEnableCycle` on mouse out with pause equal to hover', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<div class="carousel" data-cx-ride="true"></div>'
  ...
  describe('next', () => {
    ...
    it('should update indicators if present', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <button type="button" id="firstIndicator" data-cx-target="myCarousel" data-cx-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>',
          '    <button type="button" id="secondIndicator" data-cx-target="myCarousel" data-cx-slide-to="1" aria-label="Slide 2"></button>',
          '    <button type="button" data-cx-target="myCarousel" data-cx-slide-to="2" aria-label="Slide 3"></button>',
          '  </div>',
          '  <div class="carousel-inner">',
          '    <div class="carousel-item active">item 1</div>',
          '    <div class="carousel-item" data-cx-interval="7">item 2</div>',
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '</div>'
        ].join('')
    ...
    it('should call next()/prev() instance methods when clicking the respective direction buttons', () => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <button class="carousel-control-prev" type="button" data-cx-target="#carousel" data-cx-slide="prev"></button>',
        '  <button class="carousel-control-next" type="button" data-cx-target="#carousel" data-cx-slide="next"></button>',
        '</div>'
      ].join('')
  ...
  describe('cycle', () => {
    ...
    it('should get interval from data attribute on the active item element', () => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active" data-cx-interval="7">item 1</div>',
        '    <div id="secondItem" class="carousel-item" data-cx-interval="9385">item 2</div>',
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    it('should init carousels with data-cx-ride="carousel" on load', () => {
      fixtureEl.innerHTML = '<div data-cx-ride="carousel"></div>'
    ...
    it('should create carousel and go to the next slide on click (with real button controls)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '  <button class="carousel-control-prev" data-cx-target="#myCarousel" type="button" data-cx-slide="prev"></button>',
          '  <button id="next" class="carousel-control-next" data-cx-target="#myCarousel" type="button" data-cx-slide="next"></button>',
          '</div>'
        ].join('')
    ...
    it('should create carousel and go to the next slide on click (using links as controls)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '  <a class="carousel-control-prev" href="#myCarousel" role="button" data-cx-slide="prev"></a>',
          '  <a id="next" class="carousel-control-next" href="#myCarousel" role="button" data-cx-slide="next"></a>',
          '</div>'
        ].join('')
    ...
    it('should create carousel and go to the next slide on click with data-cx-slide-to', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div id="myCarousel" class="carousel slide" data-cx-ride="true">',
          '  <div class="carousel-inner">',
          '    <div class="carousel-item active">item 1</div>',
          '    <div id="item2" class="carousel-item">item 2</div>',
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '  <div id="next" data-cx-target="#myCarousel" data-cx-slide-to="1"></div>',
          '</div>'
        ].join('')
    ...
    it('should do nothing if no selector on click on arrows', () => {
      fixtureEl.innerHTML = [
        ...
        '  </div>',
        '  <button class="carousel-control-prev" data-cx-target="#myCarousel" type="button" data-cx-slide="prev"></button>',
        '  <button id="next" class="carousel-control-next" type="button" data-cx-slide="next"></button>',
        '</div>'
      ].join('')
